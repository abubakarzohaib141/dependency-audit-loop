...
### Attempts
- `zipp`: 1.0.0 -> 4.1.0 (FAIL)
  - Reasons: major version bump (1.0.0 -> 4.1.0) - policy requires human sign-off for major bumps
...
### Attempts
- `pygments`: 2.10.0 -> 2.21.0 (PASS)
  - PR: https://github.com/abubakarzohaib141/dependency-audit-loop/pull/11
